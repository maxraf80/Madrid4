...
public class Restaurants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bussiness.add(new City("Taberna Pedraza", "Ibiza, 38 ", "(+)34 91 032 72 00", "Mo to Su from 13 to 16:30 and 20:30 to 24 h", R.drawable.taberna_pedraza));
        bussiness.add(new City("La Gabinoteca", "Fernández de la Hoz, 53 ", "(+)34 91 399 15 00", "Mo to Th. from 11 a 01 h Fr-Sat 11 to 02h Su  11 to 01h.", R.drawable.gabinoteca));
        bussiness.add(new City("Macera", "San Mateo, 21 ", "(+)34 91 531 80 82", "Mo to Th. from 11 a 01 h Fr-Sat 11 to 02h Su  11 to 01h.", R.drawable.macera));
